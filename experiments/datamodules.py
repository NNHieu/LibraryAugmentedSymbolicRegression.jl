...
def _download(repo_id, revision=None):
    return snapshot_download(repo_id=repo_id, repo_type="dataset", revision=revision)

class FeynmanDataModule:
    def __init__(self, revision=None):
        self._dataset_dir = Path(_download(repo_id=FEYNMAN_REPO_ID, revision=revision))
...
class TransformedFeynmanDataModule:
    def __init__(self, revision=None):
        self._dataset_dir = Path(_download(repo_id=TRANSFORMED_FEYNMAN_REPO_ID, revision=revision))
