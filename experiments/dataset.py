...
def feynman_dataset(
    ...
    for eq_idx, p in enumerate(dm.problems):
        ...
        sample = {
            ...
            "observations": (X, y),
            "var_order": var_order,
            "hint": all_hints[p.equation_idx] if all_hints is not None else None,
        }
        dataset.append(sample)
...
def inv_feynman_dataset(
    ...
    for eq_idx, p in enumerate(dm.problems):
        ...
        sample = {
            ...
            "observations": (X, y),
            "var_order": var_order,
            "hint": all_hints[p.equation_idx.split('_')[0]] if all_hints is not None else None,
        }
        dataset.append(sample)
